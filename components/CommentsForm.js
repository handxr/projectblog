...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="cards bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Guardar mi nombre y email para próximos comentarios.</label>
        </div>
      </div>
